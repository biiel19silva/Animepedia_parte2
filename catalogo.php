...
$api_url = 'http://localhost/Animepedia_parte2/backend/api.php?resource=animes';
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button 
                                    ...
                                    onclick="window.location.href='anime_form.php?action=editar&id=<?php echo $anime['id']; ?>&foto=<?php echo urlencode($anime['foto']); ?>&nome=<?php echo urlencode($anime['nome']); ?>&idade=<?php echo urlencode($anime['idade']); ?>&genero=<?php echo urlencode($anime['genero']); ?>&anime=<?php echo urlencode($anime['cartaz']); ?>&curiosidade=<?php echo urlencode($curiosidade['curiosidade']);?>'">
                                    Editar
                                </button>
