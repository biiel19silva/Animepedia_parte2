...
if ($resource !== 'animes') {
    ...
    switch ($method) {
        case 'GET':
            // Rota: GET api.php?resource=filmes ou GET api.php?resource=animes&id=2
        ...
        case 'PUT':
            ...
            if ($id) {
                ...
                $response = array("message" => "ID do anime é obrigatório na query string para o método PUT (ex: ?resource=animes&id=123).");
            }
            break;
        ...
        case 'DELETE':
            ...
            if ($id) {
                ...
                http_response_code(400);
                $response = array("message" => "ID do anime é obrigatório na query string para o método DELETE (ex: ?resource=animes&id=123).");
            }
            break;
